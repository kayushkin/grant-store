...
func TestCreateRefusesWhatItCannotStoreBeforeAskingAnyone(t *testing.T) {
	...
	cases := []struct {
		...
		{"unknown relation", GrantRequest{PrincipalID: "principal_000001", Relation: "may_use", ResourceType: "tool", ResourceID: "1"}, "can_use, can_run_as, can_dispatch_on, can_view, can_edit, can_administer, can_run_operation, works_with"},
