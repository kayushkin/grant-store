# @kayushkin/grant-store-types

TypeScript types for grant-store's wire format, generated from the Go types in the
...
Source-only for now: install with `file:../grant-store/ts`.
